...
window.keyshotXR = function (
  X,w,G,Y,wa,D,xa,ya,za,Aa,Ba,L,M,Z,$,Ca,aa,Da,ba,Ea,ca,Fa,Ga,Ha,Ia,r,Ja
) {
  function P(a, f, b) {
    a.removeEventListener
      ? a.removeEventListener(f, b, u)
      : a.detachEvent &&
        (a.detachEvent("on" + f, a["e" + f + b]), (a["e" + f + b] = t));
  }
  function k(a, f, b) {
    a.addEventListener
      ? a.addEventListener(f, b, u)
      : a.attachEvent &&
        ((a["e" + f + b] = b),
    ...
    0 < j.d &&
      (1 == j.d
        ...
        ? ((d = a.cursor.y - E.start.y),
          ...
          (c.l += parseFloat(a.f * f - a.f * d)))
        : 3 == j.d &&
          ((f = a.cursor.x - E.start.x),
          (d = a.cursor.y - E.start.y),
  ...
  function U() {
    ...
    a.W == a.Z &&
      (1 == j.d
        ? 0.01 < i.L
          ? ((i.b.x = 0.4 * (q.a.x - i.a.x)),
            (i.b.y = 0.4 * (q.a.y - i.a.y)),
            (i.a.x += i.b.x),
            (i.a.y += i.b.y),
            a.na(i.b.x, i.b.y))
          : (a.na(q.b.x, q.b.y), (q.b.x = 0), (q.b.y = 0))
        : 0.01 < i.L &&
          ((i.b.x *= i.L),
          (i.b.y *= i.L),
    ...
    if (e.J) {
      ...
      if (
        ...
        if (((d = a.ia[d]), !d && void 0 == r[d])) {
          ...
          document.getElementById("xr_hotspot") &&
            ((b = document.getElementById("xr_hotspot")),
            document.body.removeChild(b)),
            ...
            void 0 !== r[d].options &&
              (r[d].options.fontSize &&
                (b.style.fontSize = r[d].options.fontSize),
              r[d].options.Ia && (b.style.color = r[d].options.Ia),
              r[d].options.bgColor &&
                (b.style.backgroundColor = r[d].options.bgColor),
              ...
              r[d].options.textAlign &&
                (b.style.textAlign = r[d].options.textAlign)),
            document.body.appendChild(b);
    }
    if (c.n != c.a || c.k != c.xa || c.l != c.ya)
      (c.a = c.n), (c.xa = c.k), (c.ya = c.l), na();
  };
  this.eb = function (b) {
    for (
      var f = -1e3,
  ...
  this.Ua = function (b, c) {
    ...
    a.i &&
      ((b = l.clientWidth), (c = Math.min(l.clientHeight, window.innerHeight)));
    n.style.width = b + "px";
    n.style.height = c + "px";
    n.Ba && n.Ba(b, c);
    ba &&
  ...
  this.ua = function () {
    ...
    a.U(a.o);
    a.o.$ = { Na: 0, Oa: 0, ka: 0, Pa: 1, Qa: 1, gb: 1 };
    b = "position:absolute;";
    b += "left: 0px;";
    b += "top:  0px;";
    b += "width: 80px;";
  ...
  if (document.createElement("canvas").getContext) {
    ...
    for (D = 0; D < w.length; D++)
      "undefined" !=
        typeof document.documentElement.style[w[D] + "Transform"] &&
        ((z = "-" + w[D].toLowerCase() + "-"), (N = w[D] + "Transform"));
    var b = "";
    a.h = document.getElementById(X);
    // b = "width: " + G + "px";
    // b += "height: " + Y + "px;";
    b += "aspect-ratio: 4/3;";
    b += !(window.innerHeight<window.innerWidth)?"width:100%;":"height:90%;";
    ...
    if (a.W) {
      ...
      K
        ? a.X.setAttribute("src", A + a.s + "/files/xr_hand.gif")
        : a.X.setAttribute("src", A + a.s + "/files/xr_cursor.gif");
      a.X.setAttribute(
        "style",
